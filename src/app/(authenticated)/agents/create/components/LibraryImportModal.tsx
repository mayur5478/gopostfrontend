...
export default function LibraryImportModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col rounded-2xl p-0 gap-0 overflow-hidden">
        {/* Header */}
                ...
                {mediaItems.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative border rounded-xl overflow-hidden group cursor-pointer shadow-sm hover:shadow-md transition-all ${isSelected ? 'ring-2 ring-[#FDE047] ring-offset-1' : 'border-gray-200'}`}
                    >
                      ...
                      <div className="p-2 bg-white">
                        <p className="text-xs font-medium text-gray-700 truncate" title={getFileName(item)}>
                          {getFileName(item)}
                        </p>
                      </div>
                    </div>
